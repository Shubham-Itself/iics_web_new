    ...
    sub_menus: [
      {
        ...
        inner_menus: [
          ...
          },
          {
            ...
            subHead:
              "Message from Secretary of the Ministry of Skill Development & Entrepreneurship",
            mentorMessage:
          ...
          },
          {
            ...
            subHead:
              "Message from CEO, NSDC & Managing Director, NSDC International (NSDCI) ",
            mentorMessage:
    ...
    sub_menus: [
      {
        ...
        mentorAbout:
          "Dr. Amit Behl is an Indian theatre, television and film actor. Amit Behl began his career in 1994 with a role in India's first daily soap opera Shanti. He later went on to do almost 100 TV serials in Hindi, English, Marathi, Punjabi and Urdu. He was the Hon’ble General secretary been the senior joint secretary of CINTAA (Cine & TV artistes association) from 2015 till 2024. He is a member of the governing council of MESC (Media & Entertainment skill council), advising NSDC to integrate and recognise skills in the media and entertainment industry. He is a visiting faculty at various media and management schools, including We School Mumbai, MET, DY Patil University etc.",
        courseImg:
          "/assets/iics_course_image/performing-arts-media-management.webp",
        courseOverview:
          "This two-year production-oriented performing arts course is meticulously designed to equip students with the essential skills, specialized knowledge, and practical experience necessary to excel in the competitive fields of theatre, film, television, and digital media. Through a blend of intensive training, creative projects, and professional development, graduates will be well-prepared to pursue successful and fulfilling careers in the performing arts industry The course consists of a 21-month intensive training module followed by a three-month project focused on creating video and theatrical performances.",
        mentorInfo:
        ...
        eligibilityCriteria: [
          "12th Pass from a recognized Board with an interest in performing arts and media management",
        ...
        imagesArr: Array.from(
          { length: 14 },
          (_, i) => `/assets/iics_image/perform_art/perform_art_${i + 1}.webp`
        ),
        courseCurricullam: [
          {
            title: "Semester 1",
      ...
      },
      {
        ...
        eligibilityCriteria: [
          "12th Pass from a recognized Board with an interest in makeup, hairstyling, and prosthetics.",
          "Open to makeup artists, hairstylists, fashion professionals, beauty influencers, and graduates from related disciplines. ",
        ],
        imagesArr: Array.from(
          { length: 9 },
          (_, i) => `/assets/iics_image/hair_art/hair_art_${i + 1}.webp`
        ),
        courseCurricullam: [
          {
            title: "Semester 1",
...

      {
        ...
        courseStartDate: "19.05.2025",
        courseOverview:
          "The Sound Production course is a two-year program covering sound recording, editing, and design, with hands-on training using industry-standard equipment and software equipping students with the skills needed for sound editing, mixing, and mastering. . The first semester covers sound recording techniques, sound editing, and music production, while the second semester focuses on advanced recording techniques, sound editing and mixing, and post-production sound. Students can specialize in film and television sound production, music production, or game audio design.",
        ...
        eligibilityCriteria: [
          "12th Pass from a recognized Board with an interest in sound engineering and design.",
        ...
        imagesArr: Array.from(
          { length: 13 },
          (_, i) => `/assets/iics_image/sound_images/sound_${i + 1}.webp`
        ),
        courseCurricullam: [
          {
...

      {
        ...
        imagesArr: Array.from(
          { length: 8 },
          (_, i) => `/assets/iics_image/3d_art/3d_game_${i + 1}.webp`
        ),
        courseCurricullam: [
          {
            title: "Semester 1",
...

      {
        ...
        eligibilityCriteria: [
          "12th Pass from a recognized Board with an interest in journalism, public relations, and brand communication.",
          "Open to Mass Communication, BBA, and MBA graduates, PR professionals, journalists, media strategists, and corporate communication executives.",
        ],
        courseCurricullam: [
          {
...

      {
        ...
        courseOverview:
          "The Certificate in Events and Experiential Management Program at IICS is designed to equip students with the skills needed to plan, organize, and execute various events, from corporate conferences to weddings and festivals. This two-year program combines theoretical knowledge with practical skills, covering event planning, coordination, logistics, budgeting, marketing, and client management, preparing students for diverse event management roles. This course also focuses on advanced skills in crafting impactful communication strategies, managing public relations, and building strong brand identities. With an emphasis on practical exposure, students will engage in workshops, masterclasses, and real-world projects to become adept in handling high-end PR campaigns and communication challenges.",
        industryMentors: [],
        mentorIcon: "/assets/iics_image/leaders/susma.webp",
        mentorInfo: "Academy Award Winner, Indian Sound Designer ",
        mentorAbout:
          "Ms. Sushma Gaikwad is a media entrepreneur, a communication specialist, Motivational and Tedex Speaker, a breakthrough therapist, and a Dale Carnegie certified trainer and NLP Master Practitioner. Sushma commenced her professional journey alongside her education in the Luxury industry and then joined the media industry as an experiential specialist at a time when the industry was very nascent. As one of the first few women in the media and entertainment domain, she worked with one of the top event agencies for over half a decade and was working with the pioneers in business. In the year 1997, Sushma was drawn into the arena of Corporate Identity and specialized in Corporate Identity Implementation Processes with Sista’s and Wolf-Olin’s in the UK. She was a part of the core team that designed and implemented the corporate identity of the TATA brand.",
        careerJob:
          "Sound Designer, Sound Editor, Audio Engineer, Foley Artist, Mixing/Mastering Engineer",
        careerEntrepreneurship:
          "Home Studio Business, Independent Sound Post-Production Services, Podcast & Music Production Studio Owner",
        eligibilityCriteria: [
          "12th Pass from a recognized Board with an interest in event planning and experiential marketing.",
          "Open to B.Tech, B.Sc. graduates in Sound Engineering or related disciplines, music producers, audio technicians, and professionals in the music and film industry.",
        ],
        courseCurricullam: [
          {
...

      {
        ...
        careerEntrepreneurship:
          "Home Studio Business, Independent Sound Post-Production Services, Podcast & Music Production Studio Owner",
        eligibilityCriteria: [
          "12th Pass from a recognized Board with an interest in digital media, content creation, and online branding.",
          "Open to B.Tech, B.Sc. graduates in Sound Engineering or related disciplines, music producers, audio technicians, and professionals in the music and film industry.",
        ],
        courseCurricullam: [
          {
