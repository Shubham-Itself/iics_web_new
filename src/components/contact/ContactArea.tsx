                ...
                <div className="row">
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div className="contact-box-items !p-[10px] !h-[250px] flex flex-col justify-center items-center">
                            ...
                            <h4 className="text-[16px] font-semibold">
                            Sage University <br /> Katara Hills, Extension, Bhopal,<br />  Madhya Pradesh 462022
                            </h4>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div className="contact-box-items !p-[10px] !h-[250px] flex flex-col justify-center items-center">
                            ...
                            <h4 className="text-[16px] font-semibold">
                            CH Devi Lal Centre of Learning <br /> 5, Madhya Marg, 28B, Sector 28,<br /> Chandigarh, 160028
                            </h4>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div className="contact-box-items !p-[10px] !h-[250px] flex flex-col justify-center items-center">
                            ...
                            <h4 className="text-[16px] font-semibold">
                            Karnavati University <br /> Uvarsad-Adalaj Road At.&Po. Uvarsad, Dist,<br /> Gandhinagar, Gujarat 382422
                            </h4>
                        </div>
                    </div>
                </div>
