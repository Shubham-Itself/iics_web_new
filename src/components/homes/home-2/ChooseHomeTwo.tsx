...
const ChooseHomeTwo = () => {
  return (
    <>
      <section className="choose-us-section choose-bg fix section-padding pb-0">
            ...
            <div className="row g-4 align-items-center">
              <div className="col-xxl-5 col-xl-6">
                <div className="section-title mb-0">
                  <h2
                    className="text-white wow fadeInUp !text-[36px] !mb-[20px]"
                    data-wow-delay=".3s"
                  >
                    The Future of Media <br /> is You
                  </h2>
                  <h6 className="yellow-text wow fadeInUp">Apply Now</h6>
                  <h2
                    className="text-white wow fadeInUp !text-[36px] !mb-[40px]"
                    data-wow-delay=".3s"
                  >
                    Admission Open
                  </h2>
