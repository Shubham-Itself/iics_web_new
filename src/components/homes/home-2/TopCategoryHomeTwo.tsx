        ...
        <div className="container">
          <div className="section-title text-center">
            <h6 className="text-white wow fadeInUp mobile:!text-[15px]">
              Your Journey to Media & Entertainment: Application and Program
              Structure
            </h6>
          </div>
          ...
          <div className="top-category-wrapper-2 mt-4 mt-md-0">
            <div className="row">
              <div className="col-xl-4 col-lg-6">
                <p className="text-center wow fadeInUp text-[#031F42] font-semibold">
                  Your Admission Path <span className="text-[#de4141]">to</span>{" "}
                  Success
                </p>
                      ...
                      <div className=" top-category-box bg-1 border-left-none border-top-none h-full overflow-hidden relative">
                        ...
                        <Link to="#" className="relative z-20">
                          ...
                          <div className="content">
                            <h6 className="!text-[14px] mb-[15px]">
                              Application Form Submission
                            </h6>
                            <p className="!text-[12px] leading-[18px]">
                              Begin by filling out the online application form
                              with accurate academic and personal details.
                            </p>
                          </div>
                        </Link>
                      </div>
                      ...
                      <div className="top-category-box bg-2 border-left-none border-top-none h-full overflow-hidden relative">
                        ...
                        <Link to="#" className="relative z-20">
                          ...
                          <div className="content">
                            ...
                            <p className="!text-[12px] leading-[18px]">
                              Appear for the online entrance exam designed to
                              assess your aptitude and creative potential.
                            </p>
                          </div>
                        </Link>
                      </div>
                    ...
                    >
                      <div className="top-category-box bg-3 border-left-none border-bottom-none border-top-none overflow-hidden relative">
                        ...
                        <Link to="#" className="relative z-20">
                          ...
                          <div className="content">
                            <h6 className="!text-[14px] mb-[15px]">
                              Portfolio Submission / Audition
                            </h6>
                            <p className="!text-[12px] leading-[18px]">
                              Submit your portfolio (for design/content courses)
                              or appear for an audition (for performing
                              arts-related programs), as applicable.
                            </p>
                          </div>
                        </Link>
                      </div>
                      ...
                      <div className="top-category-box bg-4 border-left-none border-bottom-none border-top-none h-full overflow-hidden relative">
                        ...
                        <Link to="#" className="relative z-20">
                          ...
                          <div className="content">
                            ...
                            <p className="!text-[12px] leading-[18px]">
                              Attend a personal interview with mentors. Final
                              selection is based on your overall performance
                              across all stages.
                            </p>
                          </div>
                        </Link>
              ...
              <div className="col-xl-4 col-lg-6">
                <h2
                  className=" wow fadeInUp mobile:!text-[12px] !text-[25px] mt-[30px] text-center mobile:!text-[18px] mobile:mb-[20px]"
                  data-wow-delay=".3s"
                >
                  Innovative Programs
                </h2>
                <div className="courses-image mb-5 mb-lg-0">
                  <img
                    src="/assets/iics_image/how_to_join_center.webp"
                    alt="img"
                    className="wow img-custom-anim-left w-[350px] h-[560px] object-cover rounded-t-[60px]"
                  />
              ...
              <div className="col-xl-4 col-lg-6 ">
                <p className="text-center wow fadeInUp text-[#031F42] font-semibold">
                  IICS Advantage <span className="text-[#de4141]">-</span> A
                  Distinctive Edge
                </p>
                    ...
                    >
                      <div className="top-category-box bg-5 border-right-none border-top-none h-full overflow-hidden relative">
                        ...
                        <Link to="#" className="relative z-20">
                          ...
                          <div className="content">
                            <h6 className="!text-[14px] mb-[15px]">
                              Unique Course Structure – 12+6+6 Model{" "}
                            </h6>
                            <p className="!text-[12px] leading-[18px]">
                              One year of intensive learning, followed by 6
                              months of LIVE industry projects and 6 months of
                              paid apprenticeship
                            </p>
                          </div>
                        </Link>
                      ...
                      <div className="top-category-box bg-6 border-right-none border-top-none h-full overflow-hidden relative">
                        ...
                        <Link to="#" className="relative z-20">
                          ...
                          <div className="content">
                            ...
                            <p className="!text-[12px] leading-[18px]">
                              Learn directly from celebrities, award-winning
                              professionals, and global experts in the creative
                              domain.
                            </p>
                          </div>
                        </Link>
                      ...
                      <div className="top-category-box bg-7 border-right-none border-bottom-none border-top-none overflow-hidden relative">
                        ...
                        <Link to="#" className="relative z-20">
                          ...
                          <div className="content">
                            ...
                            <p className="!text-[12px] leading-[18px]">
                              Study in actual studios and production settings,
                              not just classrooms — with hands-on exposure from
                              Day 1.
                            </p>
                          </div>
                        </Link>
                      ...
                      <div className="top-category-box bg-8 border-right-none border-bottom-none border-top-none overflow-hidden relative">
                        ...
                        <Link to="#" className="relative z-20">
                          ...
                          <div className="content">
                            ...
                            <p className="!text-[12px] leading-[18px]">
                              Empowering students with the skills and mindset to
                              lead, innovate, and thrive in the global media and
