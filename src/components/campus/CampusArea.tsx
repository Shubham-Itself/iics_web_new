const CampusArea = () => {
  const campusInformation = [
    ...
    },
    {
      ...
      campusSubLocation:
        "Katara Hills, Extension, Bhopal, Madhya Pradesh 462022",
      campusMobileNumber: "+91 959-4949-959",
      campusEmailId: "info@iicsindia.org",
    },
    {
      ...
      <section className="contact-section section-padding  fix">
        <div className="container">
          <div className="section-title text-center">
            ...
            <h2
              className="wow fadeInUp !text-[18px] !font-normal mobile:!text-[14px] "
              data-wow-delay=".3s"
            >
              At IICS, we believe that creativity has no boundaries — and
              neither should training. Our campuses are strategically located in
              India’s emerging creative hubs, equipped with world-class
              infrastructure, studio-grade labs, and immersive learning
              environments.
            </h2>
          </div>
          <div className="row">
            {campusInformation.map((campus, index) => (
              ...
              >
                <div className="contact-box-items">
                  ...
                  {campus.campusLocation && campus.campusSubLocation && (
                    <>
                      <h6 className="mb-[15px]">{campus.campusSubLocation}</h6>
                      <h6 className="mb-[15px]">
                        <span className="font-bold">Mobile No :</span>{" "}
                        {campus.campusMobileNumber}
                      </h6>
                      <h6 className="text-lowercase">
                        {" "}
                        <span className="font-bold">Email Id :</span>{" "}
                        {campus.campusEmailId}
                      </h6>
                    </>
                  )}
                </div>
