  ...
  return (
    <div className="py-[50px] px-[100px]">
      ...
      <div className="flex gap-[30px]">
        ...
        <p className="font-bold mt-[20px]">Job Responsibilities:</p>
      ...
      <div className="flex gap-[30px] mt-[50px]">
        ...
        <div className="border p-[50px] rounded-[20px] w-full">
        <p className="font-bold">Job Title: <span className="font-normal">Education Counsellor</span></p>
        <p className="font-bold">Location: <span className="font-normal">Delhi</span></p>
        {/* <p className="font-bold">Educational Qualification: <span className="font-normal">Any Graduation</span></p> */}
        {/* <p className="font-bold">Years of Experience: <span className="font-normal">Minimum 1 Year</span></p> */}
        <p className="font-bold mt-[20px]">Key Responsibilities:</p>
        <ul className="list-disc text-[15px]">
        ...
        <p className="font-bold mt-[20px]">Key Qualifications & Skills:</p>
        <ul className="list-disc text-[15px]">
        ...
        <p className="font-semibold text-[#005BFF] mt-[20px]">
          <span className="block">Application Process:</span>
          Interested candidates can send their CVs to hr@iicsindia.org with the subject line “Application for Education Counsellor” or call at +917428006657</p>
      ...
      <div className="flex gap-[30px] mt-[50px]">
        ...
        <div className="border p-[50px] rounded-[20px] w-full">
        <p className="font-bold">Job Title: <span className="font-normal">Content Writer</span></p>
        <p className="font-bold">Location: <span className="font-normal">Delhi</span></p>
        {/* <p className="font-bold">Educational Qualification: <span className="font-normal">Any Graduation</span></p> */}
        {/* <p className="font-bold">Years of Experience: <span className="font-normal">Minimum 1 Year</span></p> */}
        <p className="font-bold mt-[20px]">Key Responsibilities:</p>
...
<li><span className="font-semibold">Deadline Management:</span> Consistently deliver high-quality content within stipulated timelines.</li>
        ...
        <p className="font-semibold text-[#005BFF] mt-[20px]">
          <span className="block">Application Process:</span>
          Interested candidates can send their CVs to hr@iicsindia.org with the subject line “Application for Content Writer” or call at +919953895532</p>
  ...
  <div className="border p-[50px] rounded-[20px] w-full">
    <p className="font-bold">Job Title: <span className="font-normal">Business Development Manager</span></p>
    <p className="font-bold">Location: <span className="font-normal">Delhi</span></p>

    <p className="font-bold mt-[20px]">Key Responsibilities:</p>

    <p className="font-semibold mt-[15px]">Centre Setup & Operations:</p>
    <ul className="list-disc text-[15px] pl-5">
    ...
    <p className="font-bold mt-[20px]">Key Qualifications & Skills:</p>
    <ul className="list-disc text-[15px] pl-5">
      <li>Experience: Minimum 10-15 years in education management, training, or a leadership role in the Media & Entertainment, skill development, or corporate training sectors.</li>
      <li>Education: Postgraduate degree in Management, Education, Creative Arts, or related fields preferred.</li>
      <li>Leadership Skills: Strong ability to build and lead teams, drive results, and establish a high-performing institution.</li>
      <li>Strategic Thinking: Proven expertise in setting up and scaling operations, managing budgets, and achieving business targets.</li>
      <li>Industry Connections: Strong network in the education and creative industry to facilitate partnerships and collaborations.</li>
      <li>Business Acumen: Ability to identify, build, and convert revenue-generating opportunities.</li>
      <li>Communication Skills: Excellent verbal and written communication skills to engage with stakeholders, faculty, and students effectively.</li>
      <li>Problem-Solving: Ability to navigate challenges and drive innovative solutions for institutional growth.</li>
    </ul>
    ...
    <p className="font-semibold text-[#005BFF] mt-[20px]">
      <span className="block">Application Process:</span>
      Interested candidates can directly apply or send their CVs to <span className="underline">hr@iicsindia.org</span> with the subject line “Application for Business Development Manager” or call at +919953895532
    </p>
  </div>
</div>
