    ...
    <>
      <section className="team-details-section section-padding mt-[300px]">
        <div className="container">
          <div
            className="team-details-wrapper"
            style={{
              boxShadow:
          ...
          >
            <div className="team-details-items">
              ...
              <div className="team-details-content w-[82%] mt-0 mobile:w-full">
                <h2 className="mobile:!text-[20px]">{leaderName}</h2>
                ...
                {!from && (
                  <p className="mt-4 mobile:!text-[12px]">{mentorBio}</p>
                )}
                {from == "message" && (
                  <p className="mt-4 mobile:!text-[12px]">{mentorMessage}</p>
                )}
