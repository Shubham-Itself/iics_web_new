...
const CoursesDetailsArea = ({
  ...
  useEffect(() => {
    if (titleCourse == "3D Game Art") {
      setLink(
        "https://res.cloudinary.com/dwgwz52rq/video/upload/v1745234851/gaming_rtkrc2.mp4"
      );
      ...
      setLink(
        "https://res.cloudinary.com/dwgwz52rq/video/upload/v1744688387/sound_school_ybuclq.mp4"
      );
    } else if (titleCourse == "Performing Arts and Media Management") {
      setLink(
        "https://res.cloudinary.com/dwgwz52rq/video/upload/v1745401329/Performing_Arts_Media_Management_-_Amit_Sir_afw0lk.mp4"
      );
    } else if (titleCourse == "Hair, Makeup & Prosthetics") {
      setLink(
        "https://res.cloudinary.com/dwgwz52rq/video/upload/v1745401327/School_of_Performing_Arts_Media_Management_-_Yasmin_Ma_am_gar8hq.mp4"
      );
    } else if (
      titleCourse == "Advance Gaming and Extended Reality (XR) Innovations"
    ) {
      setLink(
        "https://res.cloudinary.com/dwgwz52rq/video/upload/v1745401330/School_of_Video_Games_Digital_Media_-_Anand_Sir_skoeok.mp4"
      );
    } else if (
      titleCourse ==
      ...
      setLink(
        "https://res.cloudinary.com/dwgwz52rq/video/upload/v1745477463/School_of_Creative_Communication_h80t7a.mp4"
      );
    } else if (titleCourse == "Digital Content Creation") {
      setLink(
        "https://res.cloudinary.com/dwgwz52rq/video/upload/v1745477584/School_of_Digital_Design_Content_Creation_iraeid.mp4"
      );
    } else {
      setLink(
        "https://res.cloudinary.com/dwgwz52rq/video/upload/v1744687414/events_xbzrld.mp4"
                    ...
                    <div className="tab-content">
                      <div id="Course" className="tab-pane fade active show  ">
                        <div className="description-content">
                          <p className="mb-3">{courseOverview}</p>
                      ...
                      <div id="Reviews" className="tab-pane fade">
                        <div className="courses-reviews-items">
                          <div
                            className="courses-reviews-box-items"
                            style={{
                              boxShadow:
