  ...
  return (
    <footer className={`footer-section fix ${style_2 ? "" : "footer-bg"}`}>
      <div className="container">
        <div
          className={`footer-widget-wrapper py-5 ${
            style_2 ? "style-4" : ""
          } text-white`}
        >
          <div className="row">
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="single-footer-widget">
                ...
                <p className="text-sm mb-4">
                  The Indian Institute of Creative Skills (IICS), affiliated
                  with NSDC Academy and operated by MESC (funded by NSDC) under
                  MSDE, is dedicated to shaping the future of creative
                  education.
                </p>
                <div className="flex items-center gap-3 mt-2">
                  ...
                  <div className="flex gap-3 text-lg">
                    ...
                    <a href="https://x.com/IICS_INDIA" className="text-white">
                      <i className="fab fa-twitter"></i>
                    </a>
                    <a
                      href="https://youtube.com/@iicsindiaorg?si=3jYkJMvyrO_lO97m"
                      className="text-white"
                    >
                ...
                <ul className="contact-info grid grid-cols-2 mobile:grid-cols-1 gap-4 text-sm">
                  {[
                    ...
                    },
                    {
                      title: "Ahmedabad",
                      address:
                        "Karnavati University, Uvarsad-Adalaj Road, Gandhinagar, Gujarat 382422",
                      phone: "+91 959-4949-959",
                      email: "info@iicsindia.org",
                    },
          ...
          <div
            className={`footer-bottom mt-5 text-center text-xs ${
              style_2 ? "style-4" : ""
            }`}
          >
            <p>
